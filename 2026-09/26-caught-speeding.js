...
console.log(speeding([50, 60, 55], 60)); // should return [0, 0].
console.log(speeding([58, 50, 60, 55], 55)); // should return [2, 4].
console.log(speeding([61, 81, 74, 88, 65, 71, 68], 70)); // should return [4, 8.5].
console.log(speeding([100, 105, 95, 102], 100)); // should return [2, 3.5].
console.log(speeding([40, 45, 44, 50, 112, 39], 55)); // should return [1, 57].
